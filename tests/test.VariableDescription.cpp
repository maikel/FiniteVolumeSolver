...
int main() {
  ...
  static_assert(decltype_(eq.Template(cons)) == type_c<template_t<xx::Conservative>>);
  ...
  static_assert(Conservative<Equation>::ValueTypes() == make_tuple(type_c<double>, type_c<Array<double, 2, 1>>));
  ...
  static_assert(RefBaseType(type_c<Conservative<Equation>>) == type_c<xx::Conservative<double&, Array<double, 2, 1>::MapType>>);
  static_assert(ConstRefBaseType(type_c<Conservative<Equation>>) == type_c<xx::Conservative<double&, Array<double, 2, 1>::MapType>>);
}