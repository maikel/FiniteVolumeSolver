...
# wall_filenames = ['Convergent/wall.txt']
wall_filenames = ['DivergentWithBody/wall.txt', 'DivergentWithBody/body.txt']
...
Output = { 
  ...
  # The simulation will try to hit this interval even if small time steps are neccessary.
  {
    'type': 'HDF5',
    'which_block': 0,
    'path': 'DivergentWithBody/Plenum.h5',
    'intervals': [1e-4]
  },
  ...
  # The simulation will try to hit this interval even if small time steps are neccessary.
  {
    'type': 'HDF5',
    'which_block': 1,
    'path': 'DivergentWithBody/Tube.h5',
    'intervals': [1e-5]
  },
  ...
  {
    'type': 'Plotfiles',
    'directory': 'DivergentWithBody/Plotfiles/',
    'intervals': [1e-4],
    # 'frequencies': [1]
  },
  # The next output saves the AMReX Plotfiles that are readable in Paraview or VisIt.
  ...
  {
    'type': 'Checkpoint',
    'directory': 'DivergentWithBody/Checkpoint/',
    'intervals': [1e-3],
    # 'frequencies': [1]
  },
