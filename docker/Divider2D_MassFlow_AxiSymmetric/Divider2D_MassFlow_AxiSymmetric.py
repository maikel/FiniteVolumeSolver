...
Output = {
  ...
  # {'type': 'Plotfiles', 'directory': '{}/Plotfiles'.format(OutPut_BasePath), 'intervals': [1e-4]},
  
  # Write simple HDF5 files
  # It is faster and writes a single grid without patches
  {'type': 'HDF5', 'path': '{}/Plenum.h5'.format(OutPut_BasePath, nx, shock_mach_number), 'intervals': [1e-4]},
  
  # Print out timer statistics
  {'type': 'CounterOutput', 'intervals': [1e-3] },
