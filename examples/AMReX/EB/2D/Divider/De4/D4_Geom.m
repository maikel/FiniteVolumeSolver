...
upper_center_r_low = [0.08993, 0.00183]; upper_R_l = 0.01418; %
...
idx_1_ul = round(params.N_Wall*(p_5(1)-p_3(1))/(upper_div_low_end-upper_div_low_start));
idx_2_ul = round(params.N_Wall*(p_6(1)-p_5(1))/(upper_div_low_end-upper_div_low_start));
idx_3_ul = round(params.N_Wall*(p_8(1)-p_6(1))/(upper_div_low_end-upper_div_low_start));
idx_4_ul = round(params.N_Wall*(p_10(1)-p_8(1))/(upper_div_low_end-upper_div_low_start));
idx_5_ul = params.N_Wall-idx_1_ul-idx_2_ul-idx_3_ul-idx_4_ul;
...
params.upper_div_low(:,1) = [linspace(p_3(1),p_5(1),idx_1_ul) ...
    linspace(p_5(1)+(p_6(1)-p_5(1))/(idx_2_ul+1),p_6(1)-(p_6(1)-p_5(1))/(idx_2_ul+1),idx_2_ul) ...
    linspace(p_6(1)+(p_8(1)-p_6(1))/(idx_3_ul+1),p_8(1)-(p_8(1)-p_6(1))/(idx_3_ul+1),idx_3_ul) ...
    linspace(p_8(1)+(p_10(1)-p_8(1))/(idx_4_ul+1),p_10(1)-(p_10(1)-p_8(1))/(idx_4_ul+1),idx_4_ul) ...    
    linspace(p_10(1),p_11(1),idx_5_ul)];
params.upper_div_low(:,2) = [linspace(p_3(2),p_5(2),idx_1_ul) ...
    linspace(p_5(2)+(p_6(2)-p_5(2))/(idx_2_ul+1),p_6(2)-(p_6(2)-p_5(2))/(idx_2_ul+1),idx_2_ul) ...
    linspace(p_6(2)+(p_8(2)-p_6(2))/(idx_3_ul+1),p_8(2)-(p_8(2)-p_6(2))/(idx_3_ul+1),idx_3_ul) ...
    linspace(p_8(2)+(p_10(2)-p_8(2))/(idx_4_ul+1),p_10(2)-(p_10(2)-p_8(2))/(idx_4_ul+1),idx_4_ul) ...    
    linspace(p_10(2),p_11(2),idx_5_ul)];

idx_start = idx_1_ul+idx_2_ul+1; idx_end = idx_1_ul+idx_2_ul+idx_3_ul-1;
