...
upper_center_r_low = [0.09, -0.389498]; upper_R_l = 0.397; %
...
params.upper_div_low(:,1) = linspace(p_3(1),p_11(1),params.N_Wall);
params.upper_div_low(:,2) = upper_center_r_low(2)+sqrt(upper_R_l^2 -(params.upper_div_low(:,1)-upper_center_r_low(1)).^2);
