...
Output = {
  ...
  # {'type': 'HDF5', 'path': 'Divider_{}_nx_{}_Ma_{}.h5'.format(case, nx, shock_mach_number), 'intervals': [1e-5]},
  # Print out timer statistics
  {'type': 'CounterOutput', 'intervals': [1e-4] },
  {'type': 'Checkpoint', 'directory': '{}/Checkpoint'.format(OutPut_BasePath),'intervals': [1e-6]  }
]
}
