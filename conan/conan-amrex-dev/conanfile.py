...
conan_basic_setup()''')
        ...
        # Temporary fix for issue https://github.com/AMReX-Codes/amrex/issues/426
        #tools.replace_in_file("amrex/Tools/CMake/AMReX_Config.cmake", "print_amrex_configuration_summary ()", "")
