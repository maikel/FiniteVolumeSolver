...
class SamraiConan(ConanFile):
    ...
    url = "https://github.com/LLNL/SAMRAI.git"
    ...
    def source(self):
        # self.run("git clone https://github.com/LLNL/SAMRAI.git --branch v-3-15-0 --single-branch --depth=1")
        git = tools.Git(folder="SAMRAI")
        git.clone("https://github.com/LLNL/SAMRAI.git", "v-3-15-0")
