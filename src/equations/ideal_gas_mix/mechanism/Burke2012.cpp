...
void Burke2012::ComputeThermoData(ArrayXd& h, ArrayXd& cp,
                                  Array1d T) const {
  int i;
  ...
  h.row(sN2) = 2.96733125e+02 *
               (T * (3.29867700e+00 +
                ...
                1.02090000e+03);
  cp.row(sN2) = 2.96733125e+02 *
                (3.29867700e+00 +
                 T * (1.40824000e-03 +
                      T * (-3.96322200e-06 +
                           T * (5.64151500e-09 + T * -2.44485500e-12))));
  h.row(sAR) = 2.08132126e+02 *
               (T * (2.50000000e+00 +
                     T * (0.00000000e+00 +
                          T * (0.00000000e+00 +
                               T * (0.00000000e+00 + T * 0.00000000e+00)))) -
                7.45375000e+02);
  cp.row(sAR) = 2.08132126e+02 *
                (2.50000000e+00 +
                 T * (0.00000000e+00 +
                      T * (0.00000000e+00 +
                           T * (0.00000000e+00 + T * 0.00000000e+00))));
  h.row(sH) = 8.24847438e+03 *
              (T * (2.50000000e+00 +
                    T * (0.00000000e+00 +
                         T * (0.00000000e+00 +
                              T * (0.00000000e+00 + T * 0.00000000e+00)))) +
               2.54716300e+04);
  cp.row(sH) = 8.24847438e+03 *
               (2.50000000e+00 +
                T * (0.00000000e+00 +
                     T * (0.00000000e+00 +
                          T * (0.00000000e+00 + T * 0.00000000e+00))));
  h.row(sO2) = 2.59826943e+02 *
               (T * (3.21293600e+00 +
                     T * (5.63743000e-04 +
                          T * (-1.91871667e-07 +
                               T * (3.28469250e-10 + T * -1.75371080e-13)))) -
                1.00524900e+03);
  cp.row(sO2) = 2.59826943e+02 *
                (3.21293600e+00 +
                 T * (1.12748600e-03 +
                      T * (-5.75615000e-07 +
                           T * (1.31387700e-09 + T * -8.76855400e-13))));
  h.row(sO) = 5.19653886e+02 *
              (T * (2.94642900e+00 +
                    T * (-8.19083000e-04 +
                         T * (8.07010667e-07 +
                              T * (-4.00710750e-10 + T * 7.78139200e-14)))) +
               2.91476400e+04);
  cp.row(sO) = 5.19653886e+02 *
               (2.94642900e+00 +
                T * (-1.63816600e-03 +
                     T * (2.42103200e-06 +
                          T * (-1.60284300e-09 + T * 3.89069600e-13))));
  h.row(sOH) = 4.88855960e+02 *
               (T * (4.12530561e+00 +
                     T * (-1.61272470e-03 +
                          T * (2.17588230e-06 +
                               T * (-1.44963411e-09 + T * 4.12474758e-13)))) +
                3.34630913e+03);
  cp.row(sOH) = 4.88855960e+02 *
                (4.12530561e+00 +
                 T * (-3.22544939e-03 +
                      T * (6.52764691e-06 +
                           T * (-5.79853643e-09 + T * 2.06237379e-12))));
  h.row(sH2) = 4.12423719e+03 *
               (T * (3.29812400e+00 +
                     T * (4.12472100e-04 +
                          T * (-2.71433833e-07 +
                               T * (-2.36885850e-11 + T * 8.26974400e-14)))) -
                1.01252100e+03);
  cp.row(sH2) = 4.12423719e+03 *
                (3.29812400e+00 +
                 T * (8.24944200e-04 +
                      T * (-8.14301500e-07 +
                           T * (-9.47543400e-11 + T * 4.13487200e-13))));
  h.row(sH2O) = 4.61504339e+02 *
                (T * (3.38684200e+00 +
                      T * (1.73749100e-03 +
                           T * (-2.11823200e-06 +
                                T * (1.74214525e-09 + T * -5.01317600e-13)))) -
                 3.02081100e+04);
  cp.row(sH2O) = 4.61504339e+02 *
                 (3.38684200e+00 +
                  T * (3.47498200e-03 +
                       T * (-6.35469600e-06 +
                            T * (6.96858100e-09 + T * -2.50658800e-12))));
  h.row(sHE) = 2.07861554e+03 *
               (T * (2.50000000e+00 +
                     T * (0.00000000e+00 +
                          T * (0.00000000e+00 +
                               T * (0.00000000e+00 + T * 0.00000000e+00)))) -
                7.45375000e+02);
  cp.row(sHE) = 2.07861554e+03 *
                (2.50000000e+00 +
                 T * (0.00000000e+00 +
                      T * (0.00000000e+00 +
                           T * (0.00000000e+00 + T * 0.00000000e+00))));
  h.row(sHO2) = 2.51892334e+02 *
                (T * (4.30179801e+00 +
                      T * (-2.37456025e-03 +
                           T * (7.05276303e-06 +
                                T * (-6.06909735e-09 + T * 1.85845025e-12)))) +
                 2.94808040e+02);
  cp.row(sHO2) = 2.51892334e+02 *
                 (4.30179801e+00 +
                  T * (-4.74912051e-03 +
                       T * (2.11582891e-05 +
                            T * (-2.42763894e-08 + T * 9.29225124e-12))));
  h.row(sH2O2) = 2.44427980e+02 *
                 (T * (3.38875400e+00 +
                       T * (3.28461300e-03 +
                            T * (-4.95004333e-08 +
                                 T * (-1.15645150e-09 + T * 4.94303000e-13)))) -
                  1.76631500e+04);
  cp.row(sH2O2) = 2.44427980e+02 *
                  (3.38875400e+00 +
                   T * (6.56922600e-03 +
                        T * (-1.48501300e-07 +
  ...
  if (greater_1000.any()) {
    h.row(sN2) = greater_1000.select(2.96733125e+02 *
             (T * (2.92664000e+00 +
                   T * (7.43988500e-04 +
                        T * (-1.89492033e-07 +
                             T * (2.52426000e-11 + T * -1.35067020e-15)))) -
              9.22797700e+02), h.row(sN2));
    cp.row(sN2) = greater_1000.select(2.96733125e+02 *
              (2.92664000e+00 +
               T * (1.48797700e-03 +
                    T * (-5.68476100e-07 +
                         T * (1.00970400e-10 + T * -6.75335100e-15)))), cp.row(sN2));
    h.row(sAR) = greater_1000.select(2.08132126e+02 *
             (T * (2.50000000e+00 +
                   T * (0.00000000e+00 +
                        T * (0.00000000e+00 +
                             T * (0.00000000e+00 + T * 0.00000000e+00)))) -
              7.45375000e+02), h.row(sAR));
    cp.row(sAR) = greater_1000.select(2.08132126e+02 *
              (2.50000000e+00 +
               T * (0.00000000e+00 +
                    T * (0.00000000e+00 +
                         T * (0.00000000e+00 + T * 0.00000000e+00)))), cp.row(sAR));
    h.row(sH) = greater_1000.select(8.24847438e+03 *
            (T * (2.50000000e+00 +
                  T * (0.00000000e+00 +
                       T * (0.00000000e+00 +
                            T * (0.00000000e+00 + T * 0.00000000e+00)))) +
             2.54716300e+04), h.row(sH));
    cp.row(sH) = greater_1000.select(8.24847438e+03 *
             (2.50000000e+00 +
              T * (0.00000000e+00 +
                   T * (0.00000000e+00 +
                        T * (0.00000000e+00 + T * 0.00000000e+00)))), cp.row(sH));
    h.row(sO2) = greater_1000.select(2.59826943e+02 *
             (T * (3.69757800e+00 +
                   T * (3.06759850e-04 +
                        T * (-4.19614000e-08 +
                             T * (4.43820250e-12 + T * -2.27287000e-16)))) -
              1.23393000e+03), h.row(sO2));
    cp.row(sO2) = greater_1000.select(2.59826943e+02 *
              (3.69757800e+00 +
               T * (6.13519700e-04 +
                    T * (-1.25884200e-07 +
                         T * (1.77528100e-11 + T * -1.13643500e-15)))), cp.row(sO2));
    h.row(sO) = greater_1000.select(5.19653886e+02 *
            (T * (2.54206000e+00 +
                  T * (-1.37753100e-05 +
                       T * (-1.03426767e-09 +
                            T * (1.13776675e-12 + T * -8.73610400e-17)))) +
             2.92308000e+04), h.row(sO));
    cp.row(sO) = greater_1000.select(5.19653886e+02 *
             (2.54206000e+00 +
              T * (-2.75506200e-05 +
                   T * (-3.10280300e-09 +
                        T * (4.55106700e-12 + T * -4.36805200e-16)))), cp.row(sO));
    h.row(sOH) = greater_1000.select(4.88855960e+02 *
             (T * (2.86472886e+00 +
                   T * (5.28252240e-04 +
                        T * (-8.63609193e-08 +
                             T * (7.63046685e-12 + T * -2.66391752e-16)))) +
              3.68362875e+03), h.row(sOH));
    cp.row(sOH) = greater_1000.select(4.88855960e+02 *
              (2.86472886e+00 +
               T * (1.05650448e-03 +
                    T * (-2.59082758e-07 +
                         T * (3.05218674e-11 + T * -1.33195876e-15)))), cp.row(sOH));
    h.row(sH2) = greater_1000.select(4.12423719e+03 *
             (T * (2.99142300e+00 +
                   T * (3.50032200e-04 +
                        T * (-1.87794300e-08 +
                             T * (-2.30789450e-12 + T * 3.16550400e-16)))) -
              8.35034000e+02), h.row(sH2));
    cp.row(sH2) = greater_1000.select(4.12423719e+03 *
              (2.99142300e+00 +
               T * (7.00064400e-04 +
                    T * (-5.63382900e-08 +
                         T * (-9.23157800e-12 + T * 1.58275200e-15)))), cp.row(sH2));
    h.row(sH2O) = greater_1000.select(4.61504339e+02 *
              (T * (2.67214600e+00 +
                    T * (1.52814650e-03 +
                         T * (-2.91008667e-07 +
                              T * (3.00249000e-11 + T * -1.27832360e-15)))) -
               2.98992100e+04), h.row(sH2O));
    cp.row(sH2O) = greater_1000.select(4.61504339e+02 *
               (2.67214600e+00 +
                T * (3.05629300e-03 +
                     T * (-8.73026000e-07 +
                          T * (1.20099600e-10 + T * -6.39161800e-15)))), cp.row(sH2O));
    h.row(sHE) = greater_1000.select(2.07861554e+03 *
             (T * (2.50000000e+00 +
                   T * (0.00000000e+00 +
                        T * (0.00000000e+00 +
                             T * (0.00000000e+00 + T * 0.00000000e+00)))) -
              7.45375000e+02), h.row(sHE));
    cp.row(sHE) = greater_1000.select(2.07861554e+03 *
              (2.50000000e+00 +
               T * (0.00000000e+00 +
                    T * (0.00000000e+00 +
                         T * (0.00000000e+00 + T * 0.00000000e+00)))), cp.row(sHE));
    h.row(sHO2) = greater_1000.select(2.51892334e+02 *
              (T * (4.01721090e+00 +
                    T * (1.11991006e-03 +
                         T * (-2.11219383e-07 +
                              T * (2.85615925e-11 + T * -2.15817070e-15)))) +
               1.11856713e+02), h.row(sHO2));
    cp.row(sHO2) = greater_1000.select(2.51892334e+02 *
               (4.01721090e+00 +
                T * (2.23982013e-03 +
                     T * (-6.33658150e-07 +
                          T * (1.14246370e-10 + T * -1.07908535e-14)))), cp.row(sHO2));
    h.row(sH2O2) = greater_1000.select(2.44427980e+02 *
               (T * (4.57316700e+00 +
                     T * (2.16806800e-03 +
                          T * (-4.91563000e-07 +
                               T * (5.87226000e-11 + T * -2.86330800e-15)))) -
                1.80069600e+04), h.row(sH2O2));
    cp.row(sH2O2) = greater_1000.select(2.44427980e+02 *
                (4.57316700e+00 +
                 T * (4.33613600e-03 +
                      T * (-1.47468900e-06 +
