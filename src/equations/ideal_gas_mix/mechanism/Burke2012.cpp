...
void Burke2012::ComputeThermoData(ArrayXd& h, ArrayXd& cp, Array1d T) const {
  int i;
  ...
  cp.row(sN2) =
      2.96733125e+02 *
      (3.29867700e+00 +
       T * (1.40824000e-03 + T * (-3.96322200e-06 +
  ...
  cp.row(sAR) =
      ...
      (2.50000000e+00 +
       T * (0.00000000e+00 +
            T * (0.00000000e+00 + T * (0.00000000e+00 + T * 0.00000000e+00))));
  ...
  cp.row(sO2) =
      2.59826943e+02 *
      (3.21293600e+00 +
       T * (1.12748600e-03 + T * (-5.75615000e-07 +
  ...
  cp.row(sO) =
      ...
      (2.94642900e+00 +
       T * (-1.63816600e-03 +
            T * (2.42103200e-06 + T * (-1.60284300e-09 + T * 3.89069600e-13))));
  ...
  cp.row(sOH) =
      ...
      (4.12530561e+00 +
       T * (-3.22544939e-03 +
            T * (6.52764691e-06 + T * (-5.79853643e-09 + T * 2.06237379e-12))));
  ...
  cp.row(sH2) =
      4.12423719e+03 *
      (3.29812400e+00 +
       T * (8.24944200e-04 + T * (-8.14301500e-07 +
  ...
  cp.row(sH2O) =
      4.61504339e+02 *
      (3.38684200e+00 +
       T * (3.47498200e-03 + T * (-6.35469600e-06 +
  ...
  cp.row(sHO2) =
      ...
      (4.30179801e+00 +
       T * (-4.74912051e-03 +
            T * (2.11582891e-05 + T * (-2.42763894e-08 + T * 9.29225124e-12))));
  ...
  cp.row(sH2O2) =
      2.44427980e+02 *
      (3.38875400e+00 +
       T * (6.56922600e-03 + T * (-1.48501300e-07 +
                                  T * (-4.62580600e-09 + T * 2.47151500e-12))));

  if (greater_1000.any()) {
    h.row(sN2) = greater_1000.select(
        2.96733125e+02 *
            (T * (2.92664000e+00 +
                  T * (7.43988500e-04 +
                       T * (-1.89492033e-07 +
             ...
             9.22797700e+02),
        h.row(sN2));
    cp.row(sN2) = greater_1000.select(
        2.96733125e+02 *
            (2.92664000e+00 +
             T * (1.48797700e-03 +
                  T * (-5.68476100e-07 +
    ...
    h.row(sAR) = greater_1000.select(
        2.08132126e+02 *
            (T * (2.50000000e+00 +
             ...
             7.45375000e+02),
        h.row(sAR));
    cp.row(sAR) = greater_1000.select(
        2.08132126e+02 *
            (2.50000000e+00 +
             T * (0.00000000e+00 +
                  T * (0.00000000e+00 +
    ...
    h.row(sO2) = greater_1000.select(
        2.59826943e+02 *
            (T * (3.69757800e+00 +
             ...
             1.23393000e+03),
        h.row(sO2));
    cp.row(sO2) = greater_1000.select(
        2.59826943e+02 *
            (3.69757800e+00 +
             T * (6.13519700e-04 +
                  T * (-1.25884200e-07 +
    ...
    h.row(sOH) = greater_1000.select(
        4.88855960e+02 *
            (T * (2.86472886e+00 +
             ...
             3.68362875e+03),
        h.row(sOH));
    cp.row(sOH) = greater_1000.select(
        4.88855960e+02 *
            (2.86472886e+00 +
             T * (1.05650448e-03 +
                  T * (-2.59082758e-07 +
    ...
    h.row(sH2) = greater_1000.select(
        4.12423719e+03 *
            (T * (2.99142300e+00 +
             ...
             8.35034000e+02),
        h.row(sH2));
    cp.row(sH2) = greater_1000.select(
        4.12423719e+03 *
            (2.99142300e+00 +
             T * (7.00064400e-04 +
                  T * (-5.63382900e-08 +
        ...
        cp.row(sH2));
    h.row(sH2O) = greater_1000.select(
        4.61504339e+02 *
            (T * (2.67214600e+00 +
                  T * (1.52814650e-03 +
                       T * (-2.91008667e-07 +
             ...
             2.98992100e+04),
        h.row(sH2O));
    cp.row(sH2O) = greater_1000.select(
        4.61504339e+02 *
            (2.67214600e+00 +
             T * (3.05629300e-03 +
                  T * (-8.73026000e-07 +
    ...
    h.row(sHE) = greater_1000.select(
        2.07861554e+03 *
            (T * (2.50000000e+00 +
             ...
             7.45375000e+02),
        h.row(sHE));
    cp.row(sHE) = greater_1000.select(
        2.07861554e+03 *
            (2.50000000e+00 +
             T * (0.00000000e+00 +
                  T * (0.00000000e+00 +
                       T * (0.00000000e+00 + T * 0.00000000e+00)))),
        cp.row(sHE));
    h.row(sHO2) = greater_1000.select(
        2.51892334e+02 *
            (T * (4.01721090e+00 +
                  T * (1.11991006e-03 +
                       T * (-2.11219383e-07 +
             ...
             1.11856713e+02),
        h.row(sHO2));
    cp.row(sHO2) = greater_1000.select(
        2.51892334e+02 *
            (4.01721090e+00 +
             T * (2.23982013e-03 +
                  T * (-6.33658150e-07 +
        ...
        cp.row(sHO2));
    h.row(sH2O2) = greater_1000.select(
        2.44427980e+02 *
            (T * (4.57316700e+00 +
                  T * (2.16806800e-03 +
                       T * (-4.91563000e-07 +
             ...
             1.80069600e+04),
        h.row(sH2O2));
    cp.row(sH2O2) = greater_1000.select(
        2.44427980e+02 *
            (4.57316700e+00 +
             T * (4.33613600e-03 +
                  T * (-1.47468900e-06 +
  ...
  for (i = 0; i < sEnd; i++) {
    h.row(i) =
        (!greater_300)
            .select((T_old - Array1d::Constant(300.0)) * cp.row(i) + h.row(i),
                    h.row(i));
  }
}
