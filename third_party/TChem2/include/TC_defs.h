...
/* Other work arrays */
extern double *TC_kfor, *TC_krev, *TC_kforP, *TC_krevP, *TC_kforPder, *TC_krevPder, *TC_ropFor, *TC_ropRev, *TC_rop;
extern double *TC_cpks, *TC_hks, *TC_gk, *TC_gkp ;
extern double *TC_PrDer, *TC_Crnd, *TC_CrndDer, *TC_dFfac, *TC_omg, *TC_omgP, *TC_jacFull ;
...
extern double TC_rhoref_, TC_pref_, TC_Tref_, TC_Wref_, TC_Daref_, TC_omgref_, TC_cpref_, TC_href_ ;
...
extern int *TC_isRevBackup_, *TC_reacNrpBackup_, *TC_reacNreacBackup_, *TC_reacNprodBackup_ ;
extern int *TC_reacNukiBackup_, *TC_reacSidxBackup_, *TC_reacScoefBackup_ ;
extern double *TC_reacArhenForBackup_, *TC_reacArhenRevBackup_, *TC_reacNukiDblBackup_ ;
extern int *TC_reacPfalBackup_, *TC_reacPtypeBackup_, *TC_reacPlohiBackup_, *TC_reacPspecBackup_ ;
